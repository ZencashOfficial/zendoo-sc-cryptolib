        ...
        MHTP: FieldBasedMerkleTreeParameters<Data = ConstraintF, H = H>,
{
    fn generate_constraints<CS: ConstraintSystem<ConstraintF>>(self, cs: &mut CS) -> Result<(), SynthesisError>
    {
        ...
        // 3. Check correct update of Applied Payment Transactions Merkle Tree
        ...
        let next_txs_tree_root_g = FpGadget::<ConstraintF>::alloc_input(
        ...
        let new_txs_tree_root_g = SCUtxoTreeGadget::<MHTP, HG, ConstraintF>::conditionally_enforce_leaf_insertion(
        ...
        // 4. Check the correctness of the BVT transition. This will prove:
